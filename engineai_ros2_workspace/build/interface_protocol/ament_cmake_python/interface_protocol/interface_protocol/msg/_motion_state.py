...
class MotionState(metaclass=Metaclass_MotionState):
    ...
    __slots__ = [
        '_current_motion_task',
    ]

    _fields_and_field_types = {
        'current_motion_task': 'string',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.current_motion_task = kwargs.get('current_motion_task', str())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.current_motion_task != other.current_motion_task:
            return False
        return True
    ...
    @builtins.property
    def current_motion_task(self):
        """Message field 'current_motion_task'."""
        return self._current_motion_task

    @current_motion_task.setter
    def current_motion_task(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'current_motion_task' field must be of type 'str'"
        self._current_motion_task = value
