...
#ifndef INTERFACE_PROTOCOL__MSG__DETAIL__JOINT_COMMAND__TRAITS_HPP_
#define INTERFACE_PROTOCOL__MSG__DETAIL__JOINT_COMMAND__TRAITS_HPP_
  ...
  std::ostream & out)
{
  ...
  {
    out << "parallel_parser_type: ";
    rosidl_generator_traits::value_to_yaml(msg.parallel_parser_type, out);
  }
  out << "}";
...
inline void to_yaml(
  const interface_protocol::msg::JointCommand & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const interface_protocol::msg::JointCommand & msg)
{
  return interface_protocol::msg::to_yaml(msg);
}

template<>
inline const char * data_type<interface_protocol::msg::JointCommand>()
{
  return "interface_protocol::msg::JointCommand";
}

template<>
inline const char * name<interface_protocol::msg::JointCommand>()
{
  return "interface_protocol/msg/JointCommand";
}

template<>
struct has_fixed_size<interface_protocol::msg::JointCommand>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<interface_protocol::msg::JointCommand>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<interface_protocol::msg::JointCommand>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // INTERFACE_PROTOCOL__MSG__DETAIL__JOINT_COMMAND__TRAITS_HPP_
