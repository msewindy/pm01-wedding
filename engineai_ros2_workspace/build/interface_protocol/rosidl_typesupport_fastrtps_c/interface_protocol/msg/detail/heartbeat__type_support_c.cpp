...
#include "interface_protocol/msg/detail/heartbeat__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // error_message, node_name, node_status
#include "rosidl_runtime_c/string_functions.h"  // error_message, node_name, node_status
...
using _Heartbeat__ros_msg_type = interface_protocol__msg__Heartbeat;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_runtime_c__String * str = &ros_message->node_status;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: node_status
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->node_status.data) {
      rosidl_runtime_c__String__init(&ros_message->node_status);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->node_status,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'node_status'\n");
      return false;
    }
  }
...
size_t get_serialized_size_interface_protocol__msg__Heartbeat(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Heartbeat__ros_msg_type * ros_message = static_cast<const _Heartbeat__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Heartbeat__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interface_protocol__msg__Heartbeat(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interface_protocol
size_t max_serialized_size_interface_protocol__msg__Heartbeat(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interface_protocol__msg__Heartbeat;
    is_plain =
      (
...
static size_t _Heartbeat__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interface_protocol__msg__Heartbeat(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interface_protocol, msg, Heartbeat)() {
