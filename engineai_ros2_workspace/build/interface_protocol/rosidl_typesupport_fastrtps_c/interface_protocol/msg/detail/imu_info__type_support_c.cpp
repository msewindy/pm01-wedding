...
#include "interface_protocol/msg/detail/imu_info__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/vector3__functions.h"  // angular_velocity, linear_acceleration, rpy
...
using _ImuInfo__ros_msg_type = interface_protocol__msg__ImuInfo;
...
static uint32_t _ImuInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interface_protocol__msg__ImuInfo(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interface_protocol__msg__ImuInfo;
    is_plain =
      (
...
static size_t _ImuInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interface_protocol__msg__ImuInfo(
