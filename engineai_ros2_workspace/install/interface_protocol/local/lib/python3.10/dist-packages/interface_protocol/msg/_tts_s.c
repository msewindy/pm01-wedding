...
bool interface_protocol__msg__tts__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interface_protocol.msg._tts.Tts", full_classname_dest, 31) == 0);
  }
  interface_protocol__msg__Tts * ros_message = _ros_message;
  {  // text
  ...
  {  // speaker
    ...
    rosidl_runtime_c__String__assign(&ros_message->speaker, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // rate
    ...
    ros_message->rate = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of Tts */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interface_protocol.msg._tts");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Tts");
  ...
  {  // speaker
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->speaker.data,
      strlen(ros_message->speaker.data),
      "replace");
    if (!field) {
      return NULL;
    }
  ...
  {  // rate
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->rate);
    {
