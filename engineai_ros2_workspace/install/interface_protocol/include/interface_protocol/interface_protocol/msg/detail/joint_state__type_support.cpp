...
{
  new (message_memory) interface_protocol::msg::JointState(_init);
}

void JointState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interface_protocol::msg::JointState *>(message_memory);
...
size_t size_function__JointState__torque(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<double> *>(untyped_member);
  return member->size();
}

const void * get_const_function__JointState__torque(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<double> *>(untyped_member);
  return &member[index];
...
void * get_function__JointState__torque(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<double> *>(untyped_member);
  return &member[index];
...
void fetch_function__JointState__torque(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const double *>(
    get_const_function__JointState__torque(untyped_member, index));
  auto & value = *reinterpret_cast<double *>(untyped_value);
  value = item;
}

void assign_function__JointState__torque(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<double *>(
    get_function__JointState__torque(untyped_member, index));
  const auto & value = *reinterpret_cast<const double *>(untyped_value);
  item = value;
}

void resize_function__JointState__torque(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<double> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember JointState_message_member_array[4] = {
  {
    ...
    offsetof(interface_protocol::msg::JointState, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interface_protocol::msg::JointState, position),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interface_protocol::msg::JointState, velocity),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interface_protocol::msg::JointState, torque),  // bytes offset in struct
    nullptr,  // default value
    size_function__JointState__torque,  // size() function pointer
    get_const_function__JointState__torque,  // get_const(index) function pointer
    get_function__JointState__torque,  // get(index) function pointer
    fetch_function__JointState__torque,  // fetch(index, &value) function pointer
    assign_function__JointState__torque,  // assign(index, value) function pointer
    resize_function__JointState__torque  // resize(index) function pointer
  }
};
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers JointState_message_members = {
  ...
  4,  // number of fields
  sizeof(interface_protocol::msg::JointState),
...
{
  return &::interface_protocol::msg::rosidl_typesupport_introspection_cpp::JointState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interface_protocol, msg, JointState)() {
  return &::interface_protocol::msg::rosidl_typesupport_introspection_cpp::JointState_message_type_support_handle;
}
