...
#ifndef INTERFACE_PROTOCOL__MSG__DETAIL__IMU_INFO__FUNCTIONS_H_
#define INTERFACE_PROTOCOL__MSG__DETAIL__IMU_INFO__FUNCTIONS_H_
 ...
 * calls
 * interface_protocol__msg__ImuInfo__init().
...
/**
 * It calls
 * interface_protocol__msg__ImuInfo__fini()
 ...
 * interface_protocol__msg__ImuInfo__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * interface_protocol__msg__ImuInfo__Sequence__fini()
 * on the array,
...
#endif  // INTERFACE_PROTOCOL__MSG__DETAIL__IMU_INFO__FUNCTIONS_H_
