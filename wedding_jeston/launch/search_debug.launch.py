...
def generate_launch_description():
    ...
    enable_action_arg = DeclareLaunchArgument(
        'enable_action',
        default_value='true',
        description='Enable action execution in IDLE state'
    )
    
    enable_speech_arg = DeclareLaunchArgument(
        'enable_speech',
        default_value='true',
        description='Enable speech playback in IDLE state'
    )
    ...
    return LaunchDescription([
        ...
        # 日志
        LogInfo(msg=['Starting SEARCH debug environment...']),
